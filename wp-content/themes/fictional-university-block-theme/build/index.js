...
class Like {
  ...
  ourClickDispatcher(e) {
    var currentLikeBox = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).closest('.like-box'); //identifies and stores the closest ancestral HTML element with the "like-box" class ensuring that it is always pointing to the right box

    if (currentLikeBox.attr('data-exists') == 'yes') {
      //I'm going to use attr('data-exists') instead of data('exists') because this way I can listen to the element live with each interaction and not just when the page is loaded 
...
class MyNotes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", '.edit-note', this.editNote.bind(this)); //control the status of my note - bind(this) is important here, otherwise js will modify the value of 'this' and set the equal whatever object that has been clicked on
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", '.update-note', this.updateNote.bind(this)); //makes my update
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".submit-note").on("click", this.createNote.bind(this)); //makes my insert
  }

  //My methods:
  deleteNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents('li'); //here I will get the data-id value that I put in the <li> of page-my-notes.php
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      beforeSend: xhr => {
        xhr.setRequestHeader('X-WP-Nonce', universityData.nonce); //makes WP validate the nonce code
      },
      ...
      //this line send my request for WP REST API default to delete my note
      type: 'DELETE',
      success: response => {
        thisNote.slideUp();
        console.log('deleted');
  ...
  updateNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      url: universityData.root_url + '/index.php/wp-json/wp/v2/note/' + thisNote.data('id'),
      //this line send my request for WP REST API default to edit my note
      type: 'POST',
      data: ourUpdatedPost,
      success: response => {
  ...
  createNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      //this line send my request for WP REST API default to create a new note
      type: 'POST',
      data: ourNewPost,
      success: response => {
...
class Search {
  ...
  constructor() {
    ...
    this.searchField = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#js-search-term');
    this.typingTimer;
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keydown', this.keyPressDispatcher.bind(this)); // using keydown because if the user press for a long time my search will open fast, in the first moment
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Search); //with this line can me use this file for import in my index.js
