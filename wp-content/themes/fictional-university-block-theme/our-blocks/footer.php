        ...
        <div class="group">
            ...
            <div class="site-footer__col-two-three-group">
                <div class="site-footer__col-two">
                    ...
                    <nav class="nav-list">
                        <ul>
                            ...
                            <li><a href="<?= site_url('/index.php/campuses') ?>">Campuses</a></li>
                            <!-- <?php 
                                wp_nav_menu([
                ...
                <div class="site-footer__col-three">
                    ...
                    <nav class="nav-list">
                        <ul>
                            <li><a href="<?= site_url('/index.php/politica-privacidade/') ?>">Privacy</a></li>
                            <li><a href="<?= site_url('/index.php/pet-adoption/') ?>">Pet Adoption</a></li>
                            <!-- <?php 
                                wp_nav_menu([
