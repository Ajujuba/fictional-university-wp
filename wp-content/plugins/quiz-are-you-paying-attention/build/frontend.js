...
document.addEventListener("DOMContentLoaded", function () {
  // add this line to execute my quiz when my dom is loaded. This way it doesn't break because it only enters when everything is available, now it works on my 2 themes
